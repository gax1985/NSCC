...
source: "https://learn.microsoft.com/en-us/iis/manage/provisioning-and-managing-iis/configure-logging-in-iis"
author:
  - "[[rmcmurray]]"
published:
created: 2025-11-21
...
- [Build an ASP.NET Website on IIS](https://learn.microsoft.com/en-us/iis/application-frameworks/scenario-build-an-aspnet-website-on-iis/overview-build-an-asp-net-website-on-iis)
...
- [Build a Web Farm with IIS Servers](https://learn.microsoft.com/en-us/iis/web-hosting/scenario-build-a-web-farm-with-iis-servers/overview-build-a-web-farm-with-iis-servers)
- [Hosting-Friendly Web Server Platform (IIS): Scenario Overview](https://learn.microsoft.com/en-us/iis/get-started/introduction-to-iis/hosting-friendly-web-server-platform-iis-scenario-overview)
...
[Capture Web Application Logs with App Service Diagnostics Logging - Training](https://learn.microsoft.com/en-us/training/modules/capture-application-logs-app-service/?source=recommendations)
