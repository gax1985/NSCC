...
source: "https://www.w3.org/TR/WD-logfile.html"
author:
published:
created: 2025-11-21
description:
...
[http://www.w3.org/pub/WWW/TR/WD-logfile-960323.html](https://www.w3.org/pub/WWW/TR/WD-logfile-960221.html)

Latest version:

[http://www.w3.org/pub/WWW/TR/WD-logfile.html](https://www.w3.org/pub/WWW/TR/WD-logfile.html)

Authors:

Phillip M. Hallam-Baker [<hallam@w3.org>](https://www.w3.org/TR/)  
Brian Behlendorf [<brian@organic.com>](https://www.w3.org/TR/)

---

## Status of this document

This is a W3C Working Draft for review by W3C members and other interested parties. It is a draft document and may be updated, replaced or obsoleted by other documents at any time. It is inappropriate to use W3C Working Drafts as reference material or to cite them as other than "work in progress". A list of current W3C working drafts can be found at: [http://www.w3.org/pub/WWW/TR](https://www.w3.org/pub/WWW/TR)
...
This work is in part motivated by the need to support collection of demographic data. This work is discussed at greater length in companion drafts describing [session identifier URIs](https://www.w3.org/pub/WWW/TR/WD-session-id) [\[Hallam96a\]](https://www.w3.org/TR/#Hallam96a) and more consistent [proxy behaviour](https://www.w3.org/pub/WWW/TR/WD-proxy) [\[Hallam96b\]](https://www.w3.org/TR/#Hallam96b).
...
Identifier relates to information transfer between parties defined by the value *prefix*.
...
Records whether a cache hit occurred, field has type <integer> 0 indicates a cache miss.
...
R. Fielding *[Relative Uniform Resource Locators](http://ds.internic.net/rfc/rfc1808.txt)*, June 1995

\[RFC1738\]

T. Berners-Lee, L. Masinter, *[Uniform Resource Locators (URL)](http://ds.internic.net/rfc/rfc1738.txt)*, December 1994

\[Luotonen95\]

A. Luotonen, *[The Common Logfile Format](https://www.w3.org/pub/WWW/Daemon/User/Config/Logging.html#common_logfile_format)*, 1995, http://www.w3.org/pub/WWW/Daemon/User/Config/Logging.html

\[Hallam96a\]

P. M. Hallam-Baker *[Session Identification URI](https://www.w3.org/pub/WWW/TR/WD-session-id)* World Wide Web Consortium Working Draft, WD-session-id.

\[Hallam96b\]

P. M. Hallam-Baker *[Notification for Proxy Caches](https://www.w3.org/pub/WWW/TR/WD-proxy)* World Wide Web Consortium Working Draft, WD-proxy.