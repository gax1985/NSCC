...
- [x] **Step 2.1:** Convert the `Hour` and `Minute` strings to Integers `int()`. (15 mins)
- [x] **Step 2.2:** **Condition A:** Write `if` statement for **Missing IN** (HourIN == 0). (10 mins)
- [x] **Step 2.3:** **Condition B:** Write `if` statement for **Missing OUT** (HourOUT == 0). (10 mins)
- [x] **Step 2.4:** **Verification:** Check that the "22-hour shift" employee is flagged as "Missing IN". (5 mins)
- [x] **Step 2.5:** Run the code and ensure exactly **10 anomalies** are printed to the console. (5 mins)

## Phase 3: Generating the Report (Est. 30 mins)
- [x] **Step 3.1:** Modify code to open `ANOMALIES.TXT` in write (`'w'`) mode. (5 mins)
