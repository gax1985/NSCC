...
1. required before the HTTP GET is sent by the client, the me needed for the server to transmit the
   ...
   at the given times:
2. t=0, the local host requests that the name dal.ca be resolved to an IP address.
